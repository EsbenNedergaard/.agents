---
name: fix-bug
description: Fix a bug or issue by exploring the codebase to find root cause, then create a GitHub issue with a TDD-based fix plan. Use when user reports a bug, wants to file an issue, or wants to investigate and plan a fix for a problem.
---
